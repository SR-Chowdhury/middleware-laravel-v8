...
<div class="row py-3">
    <div class="col-lg-9 offset-lg-3">
        ...
        <a href="{{ route('category_page') }}" class="btn btn-lg mx-2 btn-primary">Category</a>
        <a href="{{ route('blog_page') }}" class="btn btn-lg mx-2 btn-outline-info">Blog</a>
        <a href="{{ route('contact_page') }}" class="btn btn-lg mx-2 btn-outline-info">Contact</a>
    </div>
</div>

<div class="row">
    <div class="jumbotron">
        <h1 class="display-4 mt-3">Category | Explore SuperStar World</h1>
